...
#   value = [aws_instance.lw-instance.tags.*.Name]
# }

output "lw_server_id" {
  value = [aws_instance.lw-instance.*.id]
}

# output "lw_server_ami" {
#   value = aws_instance.lw-instance.ami
# }

# output "lw_serverinstance_type" {
#   value = aws_instance.lw-instance.instance_type
# }

output "lw_server_public_ip" {
  value = [aws_instance.lw-instance.*.public_ip]
}
